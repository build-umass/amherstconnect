...
function openDirections(event: AppEvent) {
...
export default function InteractiveMap() {
  ...
  function handlePinPress(event: AppEvent) {
  ...
  function getWalkLabel(event: AppEvent): string {
...
type MapProps = {
  ...
  onPinPress: (event: AppEvent) => void;
  onMapPress: () => void;
};
...
type NearbyPanelProps = {
  events: AppEvent[];
  userLocation: UserLocation | null;
  onCardPress: (event: AppEvent) => void;
  getWalkLabel: (event: AppEvent) => string;
};
